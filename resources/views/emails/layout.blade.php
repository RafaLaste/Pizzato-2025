...
<table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" style="width:100%;max-width:100%;">
    <tr><!-- Outer Table -->
        <td align="center"  bgcolor="#000" data-composer>

            <table border="0" align="center"  cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;background-color:#000">
                <!-- lotus-header-4 -->
                <tr>
                    <td align="center" style="background-color:#000" bgcolor="#000" class="container-padding">
                ...
                <tr>
                    <td align="center"  bgcolor="#fff" class="container-padding">
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                            ...
                            <tr>
                                <td class="center-text" align="center" style="font-family:'Roboto',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                </td>
                            </tr>
                            <tr>
                                <td class="center-text" align="center" style="font-family:'Roboto',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">

                                    <a href="tel:+5554999544154" style="color:#6e6e6e;"><span>Vale dos Vinhedos, Via dos Parreirais, Santa Lucia s/n<br /> Bento Gonçalves, RS</span></a>
                                            ...
                                            <td align="center">
                                                ...
                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <p style="margin:0px;padding:0px;color:#000;font-style:normal;font-size:11px;font-family:'Inter',Helvetica,Arial,sans-serif;font-weight:400;line-height:17px;text-decoration:none;text-transform:none;display:block;text-align:-webkit-center;text-align:center;">Você está recebendo esse conteúdo porque seu e-mail está registrado no site <a href="{{ url()->to('/') }}" target="_blank" style="font-weight:bold;margin:0px;border-top-width:0px;border-right-width:0px;border-left-width:0px;border-bottom-width:0px;border-style:none;border-bottom-style:none;padding:0px;float:none;color:#000;font-style:normal;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:11px;font-weight:bold;line-height:17px;text-transform:none;display:inline;white-space:normal;text-decoration:underline;">{{ url()->to('/') }}</a>.</p>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
