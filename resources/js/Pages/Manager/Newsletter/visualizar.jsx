...
const Page = () => {
    ...
    const breadcrumbItems = [
        ...
        { label: 'Newsletter', link: 'Manager.Contato.index' },
    ];
        ...
        <AdminLayout>
            ...
            <div className="mb-6 rounded-sm border border-stroke bg-white px-5 py-5 shadow-md">
                <div className="flex items-center justify-between">
                    <h3 className="text-xl font-bold text-black">Visualizar Contato de Newsletter</h3>
                </div>

                <div className="mt-10">
                    <div className="flex flex-col gap-y-2">
                        <p><b>E-mail</b>: {newsletter.email}</p>
                        <p><b>Data</b>: {newsletter.data }</p>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-end">
                    ...
                    <button
                        onClick={() => openModal(newsletter.id)}
                ...
                {isModalOpen && <ConfirmModal icon={faTrash} closeModal={closeModal} type="delete" confirm={route('Manager.Contato.excluir', {id: newsletter.id})} />}
            </div>
        </AdminLayout>
    );
};
