...
import { faWineBottle , faSave, faArrowLeft } from '@fortawesome/free-solid-svg-icons';
...
const Page = () => {
    const { idioma, volumes, linhas, categorias } = usePage().props;
    ...
    const inputItems = [
        ...
        [{ titulo: 'Linha', name: 'linha_id', tamanho: 'col-span-12 lg:col-span-4', tipo: 'select', options: linhas }, { titulo: 'Categoria', name: 'categoria_id', tamanho: 'col-span-12 lg:col-span-4', tipo: 'select', options: categorias }],
        ...
        [{ titulo: 'Imagem', name: 'img', tamanho: 'col-span-12 md:col-span-6', tipo: 'imagem', crop: true, largura: 960, altura: 880 }, { titulo: 'Destaque', name: 'destaque', tamanho: 'col-span-2', tipo: 'check' }],
        [{ titulo: 'Imagem Fundo', name: 'img_bg', tamanho: 'col-span-12 md:col-span-6', tipo: 'imagem', crop: true, largura: 540, altura: 700 }, { titulo: 'Imagem infinito', name: 'img_full', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'imagem', crop: false, largura: 300, altura: 1000 }],
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faWineBottle} items={breadcrumbItems} current="Adicionar" idioma={idioma.codigo} />
