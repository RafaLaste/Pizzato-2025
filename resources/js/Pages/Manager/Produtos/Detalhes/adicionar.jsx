...
const Page = () => {
    ...
    const breadcrumbItems = [
        ...
        { label: 'Editar Produto', link: 'Manager.Produtos.editar', params: { id: id }},
    ];
    ...
    const inputItems = [
        ...
        [{ titulo: 'Ícone', name: 'img', tamanho: 'col-span-12 md:col-span-6', tipo: 'imagem', crop: false, largura: 103, altura: 103 }]
    ];
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('Manager.Produtos.Detalhes.novo', {id: id}), {
            preserveScroll: true
        });
        console.log(data);
                ...
                <div className="mt-10">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-end">
                            <Link href={route('Manager.Produtos.Detalhes.index', {id: id})} className="flex items-center w-fit rounded-lg border border-red-700 text-red-700 px-3 py-2 mr-3 cursor-pointer transition-all hover:bg-red-100">
