...
const Page = () => {
    ...
    const breadcrumbItems = [
        ...
        { label: 'Categorias', link: 'Manager.Linhas.index' },
    ];

    const inputItems = [
        [{ titulo: 'Nome', name: 'nome', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'texto', max: 120 }, { titulo: 'Tipo', name: 'tipo', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'texto', max: 120 }],
    ];
    ...
    const handleSubmit = (e) => {
        ...
        post(route('Manager.Categorias.atualizar', {id: categoria.id, lang: idioma_url}), {
            preserveScroll: true,
        });
        console.log(data);
