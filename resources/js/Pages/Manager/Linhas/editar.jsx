...
const Page = () => {
    const { idioma, idiomas, linha } = usePage().props;

    const { data, setData, post, processing, errors } = useForm(linha);
    ...
    const inputItems = [
        ...
        [{ titulo: 'Banner', name: 'img', tamanho: 'col-span-12 md:col-span-6', tipo: 'imagem', crop: true, largura: 1920, altura: 1020, imagem: linha.banner }, { titulo: 'Logo', name: 'img_logo', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'imagem', crop: false, largura: 200, altura: 100, imagem: linha.logo }],
        [{ titulo: 'Banner Rodapé', name: 'img_footer', tamanho: 'col-span-12 md:col-span-6', tipo: 'imagem', crop: true, largura: 1920, altura: 1052, imagem: linha.banner_rodape }, { titulo: 'Imagem Destaques', name: 'img_featured', tamanho: 'col-span-12 md:col-span-6', tipo: 'imagem', crop: true, largura: 960, altura: 880, imagem: linha.imagem_destaques }],
    ...
    const handleSubmit = (e) => {
        ...
        post(route('Manager.Linhas.atualizar', {id: linha.id, lang: idioma_url}), {
            preserveScroll: true,
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faTimeline} items={breadcrumbItems} current="Editar" idioma={idioma.codigo} idiomas={idiomas} id={linha.id} />
