...
const Page = () => {
    const { idioma, idiomas, vinhedo } = usePage().props;

    const { data, setData, post, processing, errors } = useForm(vinhedo);
    ...
    const inputItems = [
        ...
        [{ titulo: 'Banner Desktop', name: 'img', tamanho: 'col-span-12 md:col-span-6', tipo: 'imagem', crop: true, largura: 1920, altura: 700, imagem: vinhedo.banner }, { titulo: 'Banner Mobile', name: 'img_mobile', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'imagem', crop: true, largura: 1080, altura: 750, imagem: vinhedo.banner_mobile }],
    ...
    const handleSubmit = (e) => {
        ...
        post(route('Manager.Vinhedos.atualizar', {id: vinhedo.id, lang: idioma_url}), {
            preserveScroll: true,
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faSeedling} items={breadcrumbItems} current="Editar" idioma={idioma.codigo} idiomas={idiomas} id={vinhedo.id} />
